...
const defaultArray = structuredClone(data);
...
const selector = document.getElementsByClassName("price-selector");
selector[0].addEventListener("change" , () => {
  
  if (selector[0].value == "descending-price") {
    removeAllChildNodes(contain);
    appendProducts(data);
    contain.style.flexFlow = "row-reverse wrap-reverse";
    
  }
  else if(selector[0].value == "ascending-price") {
    removeAllChildNodes(contain);
    appendProducts(data); 
